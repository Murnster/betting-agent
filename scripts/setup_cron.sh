...
echo ""
echo "# 5. Daily DB Backup (03:15): Store a compressed PostgreSQL dump and prune old backups"
echo "15 3 * * * cd $PROJECT_ROOT && uv run python scripts/backup_db.py >> $LOG_DIR/db_backup.log 2>&1"
echo ""
echo "---------------------------------------------------------"
